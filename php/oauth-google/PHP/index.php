...
$client->setApplicationName("LAS Sign in with GPlus"); // Set your applicatio name
...
$client->setRedirectUri($redirect_uri); // paste the redirect URI where you given in APi Console. You will get the Access Token here during login success
//$client->setDeveloperKey($client_id); // Developer key
